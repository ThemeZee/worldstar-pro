 ...
 */
class WorldStar_Pro_Magazine_Vertical_Box_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => esc_html__( 'Displays your posts from a selected category in a vertical box.', 'worldstar-pro' ),
	...
	private function default_settings() {
		...
		$defaults = array(
			'title'    => esc_html__( 'Magazine (Vertical Box)', 'worldstar-pro' ),
			'category' => 0,
		);
	...
	function render( $settings ) {
		...
		// Get cached post ids.
		$post_ids = worldstar_get_magazine_post_ids( $this->id, $settings['category'], 5 );
