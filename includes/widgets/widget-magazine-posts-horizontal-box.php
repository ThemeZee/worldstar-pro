 ...
 */
class WorldStar_Pro_Magazine_Horizontal_Box_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			esc_html__( 'Magazine (Horizontal Box)', 'worldstar' ), // Name.
			array(
				'classname' => 'worldstar-magazine-horizontal-box-widget',
				'description' => esc_html__( 'Displays your posts from a selected category in a horizontal box. Please use this widget ONLY in the Magazine Homepage widget area.', 'worldstar' ),
	...
	function render( $settings ) {
		...
		// Get cached post ids.
		$post_ids = worldstar_get_magazine_post_ids( $this->id, $settings['category'], 4 );
 ...
 * Register Widget
 */
function worldstar_register_magazine_posts_horizontal_box_widget() {

	register_widget( 'WorldStar_Pro_Magazine_Horizontal_Box_Widget' );

}
add_action( 'widgets_init', 'worldstar_register_magazine_posts_horizontal_box_widget' );
