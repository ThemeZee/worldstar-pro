...
class WorldStar_Pro_Magazine_Posts_Single_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			esc_html__( 'Magazine (Single Post)', 'worldstar-pro' ), // Name.
			array(
				'classname' => 'worldstar-magazine-single-widget',
				'description' => esc_html__( 'Displays a single post from a selected category.', 'worldstar-pro' ),
	...
	private function default_settings() {
		...
		$defaults = array(
			'title'    => esc_html__( 'Magazine (Single Post)', 'worldstar-pro' ),
			'category' => 0,
		);
	...
	function widget( $args, $instance ) {
		...
		if ( ! function_exists( 'worldstar_get_magazine_post_ids' ) ) {
	...
	function render( $settings ) {
		...
		// Get cached post id.
		$post_id = worldstar_get_magazine_post_ids( $this->id, $settings['category'], 1 );
