 ...
 */
class WorldStar_Pro_Magazine_Posts_Boxed_Widget extends WP_Widget {
	...
	function __construct() {
		...
		// Setup Widget.
		parent::__construct(
			'worldstar-magazine-posts-boxed', // ID.
			sprintf( esc_html__( 'Magazine Posts: Boxed (%s)', 'worldstar-pro' ), 'WorldStar Pro' ), // Name.
			array(
				'classname' => 'worldstar_magazine_posts_boxed',
				'description' => esc_html__( 'Displays your posts from a selected category in a boxed layout. Please use this widget ONLY in the Magazine Homepage widget area.', 'worldstar-pro' ),
	...
	function widget( $args, $instance ) {
		...
		if ( ! $this->is_preview() ) {
			$cache = wp_cache_get( 'widget_worldstar_magazine_posts_boxed', 'widget' );
		}
		if ( ! is_array( $cache ) ) {
			$cache = array();
		}
		...
		if ( ! $this->is_preview() ) {
			...
			wp_cache_set( 'widget_worldstar_magazine_posts_boxed', $cache, 'widget' );
		} else {
			ob_end_flush();
		}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'layout' ); ?>"><?php esc_html_e( 'Post Layout:', 'worldstar-pro' ); ?></label><br/>
			<select id="<?php echo $this->get_field_id( 'layout' ); ?>" name="<?php echo $this->get_field_name( 'layout' ); ?>">
				<option <?php selected( $settings['layout'], 'horizontal' ); ?> value="horizontal" ><?php esc_html_e( 'Horizontal Arrangement', 'worldstar-pro' ); ?></option>
				<option <?php selected( $settings['layout'], 'vertical' ); ?> value="vertical" ><?php esc_html_e( 'Vertical Arrangement', 'worldstar-pro' ); ?></option>
			</select>
		</p>
	...
	public function delete_widget_cache() {
		...
		wp_cache_delete( 'widget_worldstar_magazine_posts_boxed', 'widget' );
