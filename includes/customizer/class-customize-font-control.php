...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class WorldStar_Pro_Customize_Font_Control extends WP_Customize_Control {
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => esc_html__( 'Previous Font', 'worldstar-pro' ),
				'next'     => esc_html__( 'Next Font', 'worldstar-pro' ),
				'standard' => esc_html_x( 'Default', 'default font button', 'worldstar-pro' ),
			);

			// Set Fonts.
			$this->local_fonts = WorldStar_Pro_Custom_Fonts::get_local_fonts();
			$this->google_fonts = WorldStar_Pro_Custom_Fonts::get_google_fonts();
				...
				<label>
					...
					<div class="customize-font-select-control">
						<select <?php $this->link(); ?>>
							<optgroup label="<?php esc_html_e( 'Local Fonts', 'worldstar-pro' ); ?>">
								<?php
							...
							<optgroup label="<?php esc_html_e( 'Google Web Fonts', 'worldstar-pro' ); ?>">
	  							<?php
